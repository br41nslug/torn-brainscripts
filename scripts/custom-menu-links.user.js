...
// @downloadURL  https://raw.githubusercontent.com/br41nslug/torn-brainscripts/main/scripts/custom-menu-links.user.js
 ...
 */
 const customLinks = [
    { label: "Raceway", after: "home", target: "/page.php?sid=racing", icon: '<i class="cql-raceway"></i>' },
